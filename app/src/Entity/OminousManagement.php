...
class OminousManagement
{
     ...
     * @var float
     *
     * @ORM\Column(name="services_value", type="float", precision=10, scale=0, nullable=true)
     */
     ...
     * @var float
     *
     * @ORM\Column(name="services_percentage", type="float", precision=10, scale=0, nullable=true)
     */
