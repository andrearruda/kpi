...
class HealthOperators
{
     ...
     * @var float
     *
     * @ORM\Column(name="medical_services_value", type="float", precision=10, scale=0, nullable=false)
     */
     ...
     * @var float
     *
     * @ORM\Column(name="medical_services_percentage", type="float", precision=10, scale=0, nullable=false)
     */
     ...
     * @var float
     *
     * @ORM\Column(name="workout_value", type="float", precision=10, scale=0, nullable=false)
     */
     ...
     * @var float
     *
     * @ORM\Column(name="workout_percentage", type="float", precision=10, scale=0, nullable=false)
     */
