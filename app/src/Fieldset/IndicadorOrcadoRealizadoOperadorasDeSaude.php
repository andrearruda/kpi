...
class IndicadorOrcadoRealizadoOperadorasDeSaude extends Fieldset implements InputFilterProviderInterface
{
    public function __construct()
    {
        parent::__construct('fieldset_orcadorealizado_operadorasdesaude');
